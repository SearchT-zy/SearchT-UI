# SearchT-UI rebrand substitution table (GNU sed).
...
s/ZHIXU/SEARCHT/g
s/知序/SearchT-UI/g
s/Zhixu/SearchT-UI/g
s/zhixu/searcht/g
# AionUi brand strings -> SearchT-UI, skipping lines with functional legacy tokens.
/aionui\.db\|aionui-config\.txt\|aionui-backend\.db\|aionui-chat\|\.aionui-env\|aionui\.dir\|'AionUi'\|"AionUi"\|AionCore\|iOfficeAI/!s/AionUi/SearchT-UI/g
