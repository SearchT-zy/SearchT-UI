...
function printTerminalReport(report: BenchReport): void {
  console.log('\n  ╔══════════════════════════════════════════════════════════════╗');
  console.log('  ║              SearchT-UI Performance Benchmark Report            ║');
  console.log('  ╚══════════════════════════════════════════════════════════════╝');
...
<head>
<meta charset="utf-8">
<title>SearchT-UI Benchmark Report - ${report.timestamp}</title>
<style>
...
<body>
<h1>SearchT-UI Performance Benchmark Report</h1>
<div class="meta">
