...
# ============================================================================
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/searcht-ui/SearchT/main/scripts/install-web.sh | bash
#   # Or specify version:
...
MIRROR="${MIRROR:-https://github.com/searcht-ui/SearchT/releases/download}"
...
download_tarball() {
    ...
    # Build download URL
    # MIRROR formats:
    #   - GitHub: https://github.com/searcht-ui/SearchT/releases/download
...
print_summary() {
    ...
    echo ""
    echo -e "  ${BOLD}📖 Documentation:${NC}  https://github.com/searcht-ui/SearchT"
    echo -e "  ${BOLD}🐛 Report issues:${NC}  https://github.com/searcht-ui/SearchT/issues"
    echo ""
