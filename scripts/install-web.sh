#!/usr/bin/env bash
# ============================================================================
# SearchT WebUI — One-Click Installation Script
# ============================================================================
# Usage:
#   curl -fsSL https://raw.githubusercontent.com/SearchT-zy/SearchT/main/scripts/install-web.sh | bash
#   # Or specify version:
...
MIRROR="${MIRROR:-https://github.com/SearchT-zy/SearchT/releases/download}"
...
banner() {
    echo -e "${CYAN}${BOLD}"
    echo "  ╔══════════════════════════════════════════════╗"
    echo "  ║     SearchT WebUI Installer (No Electron)     ║"
    echo "  ╚══════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
download_tarball() {
    ...
    # Build download URL
    # MIRROR formats:
    #   - GitHub: https://github.com/SearchT-zy/SearchT/releases/download
...
print_summary() {
    ...
    echo -e "${GREEN}${BOLD}  🎉 SearchT WebUI v${VERSION} Installed!${NC}"
    echo -e "${GREEN}${BOLD}══════════════════════════════════════════════════${NC}"
    echo ""
    ...
    if [[ "$CREATE_SYMLINK" == "1" && ":$PATH:" == *":${BIN_DIR}:"* ]]; then
        echo "    # Start SearchT WebUI"
        echo "    searcht-web start"
        echo ""
        echo "    # Check version"
        echo "    searcht-web version"
    else
        echo "    # Start SearchT WebUI (using full path)"
    ...
    echo ""
    echo -e "  ${BOLD}📖 Documentation:${NC}  https://github.com/SearchT-zy/SearchT"
    echo -e "  ${BOLD}🐛 Report issues:${NC}  https://github.com/SearchT-zy/SearchT/issues"
    echo ""
