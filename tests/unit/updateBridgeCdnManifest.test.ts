...
describe('mapCdnManifestToRelease', () => {
  it('maps files to CDN-primary assets with GitHub fallback URLs', () => {
    ...
    const release = mapCdnManifestToRelease(manifest, 'SearchT-zy/SearchT');
    ...
    expect(dmg?.fallbackUrl).toBe(
      'https://github.com/SearchT-zy/SearchT/releases/download/v2.1.45/SearchT-2.1.45-mac-arm64.dmg'
    );
