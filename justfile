...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  SearchT Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
info:
    #!/usr/bin/env bash
    echo "SearchT Build Environment"
    echo "========================"
...
build-win: preflight
    ...
    Get-Process -Name "SearchT","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
