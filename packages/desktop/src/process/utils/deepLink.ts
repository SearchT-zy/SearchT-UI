...
export const PROTOCOL_SCHEME = SEARCHT_BRAND.protocol;

/**
 * Parse a searcht:// URL into action and params.
 * Supports two formats:
 *   1. searcht://add-provider?base_url=xxx&api_key=xxx
 *   2. searcht://provider/add?v=1&data=<base64 JSON>  (one-api / new-api style)
 */
