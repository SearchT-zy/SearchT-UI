...
export const SINGLE_TARGET_ID = 'searcht-browser-target';
export const SINGLE_SESSION_ID = 'searcht-browser-session';
export const SINGLE_BROWSER_CONTEXT_ID = 'searcht-browser-context';
