...
/**
 * A file reference sent with a chat message. Mirrors the backend's `ChatFileRef`
...
/**
 * How `POST /api/fs/content` encodes returned file content. Mirrors the backend's
