...
import type { Task, TaskCreateInput, TaskListQuery, TaskUpdateInput, TaskScope } from '@/common/types/searcht/tasks';
import type {
...
export const application = {
  ...
  // The backend reads SEARCHT_*_DIR env vars on boot, so it does not own this config.
...
export const personalWorkspace = {
  getPreferences: bridge.buildProvider<WorkspacePreferences, void>('personal.workspace.preferences.get'),
  setPreferences: bridge.buildProvider<WorkspacePreferences, WorkspacePreferences>(
    'personal.workspace.preferences.set'
  ),
  getHealth: bridge.buildProvider<PersonalCoreHealth, void>('personal.workspace.health.get'),
  createBackup: bridge.buildProvider<PersonalBackupResult, void>('personal.workspace.backup.create'),
  discoverSearchtImport: bridge.buildProvider<SearchtImportDiscovery, void>('personal.workspace.import.discover'),
  planSearchtImport: bridge.buildProvider<SearchtImportPlan, void>('personal.workspace.import.plan'),
  runSearchtImport: bridge.buildProvider<SearchtImportReport, void>('personal.workspace.import.run'),
  listSearchtImports: bridge.buildProvider<SearchtImportReport[], void>('personal.workspace.import.list'),
  rollbackSearchtImport: bridge.buildProvider<SearchtImportReport, { id: string }>(
    'personal.workspace.import.rollback'
  ),
};

export const cloudSync = {
  getStatus: bridge.buildProvider<CloudSyncStatus, void>('searcht.cloud-sync.status.get'),
  configure: bridge.buildProvider<CloudSyncStatus, CloudSyncConfigureInput>('searcht.cloud-sync.configure'),
  syncNow: bridge.buildProvider<CloudSyncReport, void>('searcht.cloud-sync.sync-now'),
  disable: bridge.buildProvider<CloudSyncStatus, void>('searcht.cloud-sync.disable'),
};

export const connectors = {
  list: bridge.buildProvider<ConnectorAccount[], void>('searcht.connectors.list'),
  create: bridge.buildProvider<ConnectorSyncResult, ConnectorCreateInput>('searcht.connectors.create'),
  testEmail: bridge.buildProvider<void, EmailConnectorTestInput>('searcht.connectors.email.test'),
  createEmail: bridge.buildProvider<ConnectorSyncResult, EmailConnectorCreateInput>('searcht.connectors.email.create'),
  testWebDav: bridge.buildProvider<void, WebDavConnectorTestInput>('searcht.connectors.webdav.test'),
  createWebDav: bridge.buildProvider<ConnectorSyncResult, WebDavConnectorCreateInput>(
    'searcht.connectors.webdav.create'
  ),
  testS3: bridge.buildProvider<void, S3ConnectorTestInput>('searcht.connectors.s3.test'),
  createS3: bridge.buildProvider<ConnectorSyncResult, S3ConnectorCreateInput>('searcht.connectors.s3.create'),
  testCalendarIcs: bridge.buildProvider<void, CalendarIcsConnectorTestInput>('searcht.connectors.calendar-ics.test'),
  createCalendarIcs: bridge.buildProvider<ConnectorSyncResult, CalendarIcsConnectorCreateInput>(
    'searcht.connectors.calendar-ics.create'
  ),
  sync: bridge.buildProvider<ConnectorSyncResult, { id: string }>('searcht.connectors.sync'),
  setState: bridge.buildProvider<ConnectorAccount, ConnectorSetStateInput>('searcht.connectors.state'),
  disconnect: bridge.buildProvider<void, { id: string }>('searcht.connectors.disconnect'),
};

export const collaboration = {
  list: bridge.buildProvider<CollaborationSnapshot, { teamId: string; limit?: number }>('searcht.collaboration.list'),
  createInstruction: bridge.buildProvider<CollaborationSnapshot, CollaborationCreateInput>(
    'searcht.collaboration.instructions.create'
  ),
  appendEvent: bridge.buildProvider<CollaborationMessage, CollaborationAppendEventInput>(
    'searcht.collaboration.events.append'
  ),
  updateDelivery: bridge.buildProvider<CollaborationDelivery, CollaborationDeliveryUpdate>(
    'searcht.collaboration.deliveries.update'
  ),
  updateDeliveryByRun: bridge.buildProvider<CollaborationDelivery[], CollaborationRunDeliveryUpdate>(
    'searcht.collaboration.deliveries.update-by-run'
  ),
  removeTeam: bridge.buildProvider<void, { teamId: string }>('searcht.collaboration.team.remove'),
  listMembers: bridge.buildProvider<CollaborationMember[], { teamId: string }>('searcht.collaboration.members.list'),
  createInviteCode: bridge.buildProvider<CollaborationInviteCode, CollaborationInviteCreateInput>(
    'searcht.collaboration.invites.create'
  ),
  listInviteCodes: bridge.buildProvider<CollaborationInviteCode[], { teamId: string }>(
    'searcht.collaboration.invites.list'
  ),
  revokeInviteCode: bridge.buildProvider<CollaborationInviteCode, { id: string }>(
    'searcht.collaboration.invites.revoke'
  ),
  joinByInviteCode: bridge.buildProvider<CollaborationJoinResult, CollaborationJoinInput>(
    'searcht.collaboration.invites.join'
  ),
  removeMember: bridge.buildProvider<void, { teamId: string; memberId: string }>(
    'searcht.collaboration.members.remove'
  ),
};
...
export const task = {
  ...
  list: bridge.buildProvider<Task[], TaskListQuery>('searcht.task.list'),
  create: bridge.buildProvider<Task, TaskCreateInput>('searcht.task.create'),
  update: bridge.buildProvider<Task, TaskUpdateInput & { scope?: TaskScope }>('searcht.task.update'),
  complete: bridge.buildProvider<{ task: Task; nextTask?: Task }, { id: string }>('searcht.task.complete'),
  reopen: bridge.buildProvider<Task, { id: string }>('searcht.task.reopen'),
  remove: bridge.buildProvider<void, { id: string; scope?: TaskScope }>('searcht.task.remove'),
  restore: bridge.buildProvider<Task, { id: string }>('searcht.task.restore'),
  destroy: bridge.buildProvider<void, { id: string }>('searcht.task.destroy'),
  emptyTrash: bridge.buildProvider<{ removed: number }, void>('searcht.task.empty-trash'),
};

export const calendar = {
  list: bridge.buildProvider<CalendarEvent[], CalendarRangeQuery>('searcht.calendar.list'),
  get: bridge.buildProvider<CalendarEvent | null, { id: string }>('searcht.calendar.get'),
  create: bridge.buildProvider<CalendarEvent, CalendarEventCreateInput>('searcht.calendar.create'),
  update: bridge.buildProvider<CalendarEvent, CalendarEventUpdateInput & { scope?: CalendarScope }>(
    'searcht.calendar.update'
  ),
  remove: bridge.buildProvider<void, { id: string; scope?: CalendarScope }>('searcht.calendar.remove'),
  restore: bridge.buildProvider<CalendarEvent, { id: string }>('searcht.calendar.restore'),
  destroy: bridge.buildProvider<void, { id: string }>('searcht.calendar.destroy'),
  emptyTrash: bridge.buildProvider<{ removed: number }, void>('searcht.calendar.empty-trash'),
  listBlocks: bridge.buildProvider<ScheduleBlock[], CalendarRangeQuery>('searcht.calendar.blocks.list'),
  createBlock: bridge.buildProvider<ScheduleBlock, ScheduleBlockCreateInput>('searcht.calendar.blocks.create'),
  updateBlock: bridge.buildProvider<ScheduleBlock, ScheduleBlockUpdateInput>('searcht.calendar.blocks.update'),
  removeBlock: bridge.buildProvider<void, { id: string }>('searcht.calendar.blocks.remove'),
  restoreBlock: bridge.buildProvider<ScheduleBlock, { id: string }>('searcht.calendar.blocks.restore'),
  destroyBlock: bridge.buildProvider<void, { id: string }>('searcht.calendar.blocks.destroy'),
...
export const inbox = {
  list: bridge.buildProvider<InboxListResult, InboxListQuery>('searcht.inbox.list'),
  get: bridge.buildProvider<InboxItemDetail | null, { id: string }>('searcht.inbox.get'),
  captureText: bridge.buildProvider<InboxItem, InboxTextCaptureInput>('searcht.inbox.capture-text'),
  captureLink: bridge.buildProvider<InboxItem, InboxLinkCaptureInput>('searcht.inbox.capture-link'),
  importFiles: bridge.buildProvider<InboxImportResult, InboxFileImportInput>('searcht.inbox.import-files'),
  update: bridge.buildProvider<InboxItem, InboxUpdateInput>('searcht.inbox.update'),
  archive: bridge.buildProvider<InboxMutationResult, { ids: string[] }>('searcht.inbox.archive'),
  remove: bridge.buildProvider<InboxMutationResult, { ids: string[] }>('searcht.inbox.remove'),
  restore: bridge.buildProvider<InboxMutationResult, { ids: string[] }>('searcht.inbox.restore'),
  destroy: bridge.buildProvider<InboxMutationResult, { ids: string[] }>('searcht.inbox.destroy'),
  emptyTrash: bridge.buildProvider<InboxMutationResult, void>('searcht.inbox.empty-trash'),
  convertToTask: bridge.buildProvider<InboxConversionResult, InboxTaskConversionInput>('searcht.inbox.convert-task'),
  convertToEvent: bridge.buildProvider<InboxConversionResult, InboxEventConversionInput>('searcht.inbox.convert-event'),
  convertToNote: bridge.buildProvider<InboxConversionResult, InboxNoteConversionInput>('searcht.inbox.convert-note'),
  convertToKnowledge: bridge.buildProvider<InboxConversionResult, InboxKnowledgeConversionInput>(
    'searcht.inbox.convert-knowledge'
  ),
  getPendingSummary: bridge.buildProvider<InboxPendingSummary, { limit: number }>('searcht.inbox.pending-summary'),
  getPreview: bridge.buildProvider<InboxPreviewDescriptor, { id: string }>('searcht.inbox.preview'),
  revealManagedFile: bridge.buildProvider<void, { id: string }>('searcht.inbox.reveal-managed-file'),
};

export const notes = {
  list: bridge.buildProvider<NoteListResult, NoteListQuery>('searcht.notes.list'),
  get: bridge.buildProvider<NoteDetail | null, { id: string }>('searcht.notes.get'),
  create: bridge.buildProvider<NoteDetail, NoteCreateInput>('searcht.notes.create'),
  update: bridge.buildProvider<NoteDetail, NoteUpdateInput>('searcht.notes.update'),
  archive: bridge.buildProvider<NoteMutationResult, { ids: string[] }>('searcht.notes.archive'),
  unarchive: bridge.buildProvider<NoteMutationResult, { ids: string[] }>('searcht.notes.unarchive'),
  remove: bridge.buildProvider<NoteMutationResult, { ids: string[] }>('searcht.notes.remove'),
  restore: bridge.buildProvider<NoteMutationResult, { ids: string[] }>('searcht.notes.restore'),
  destroy: bridge.buildProvider<NoteMutationResult, { ids: string[] }>('searcht.notes.destroy'),
  emptyTrash: bridge.buildProvider<NoteMutationResult, void>('searcht.notes.empty-trash'),
  listRevisions: bridge.buildProvider<NoteRevisionListResult, NoteRevisionListQuery>('searcht.notes.revisions.list'),
  restoreRevision: bridge.buildProvider<NoteDetail, NoteRevisionRestoreInput>('searcht.notes.revisions.restore'),
};

export const knowledge = {
  search: bridge.buildProvider<KnowledgeSearchResult, KnowledgeSearchQuery>('searcht.knowledge.search'),
  getStatus: bridge.buildProvider<KnowledgeIndexStatus, void>('searcht.knowledge.status'),
  rebuild: bridge.buildProvider<KnowledgeRebuildResult, void>('searcht.knowledge.rebuild'),
  removeSource: bridge.buildProvider<void, { id: string }>('searcht.knowledge.remove-source'),
};

export const memory = {
  listCandidates: bridge.buildProvider<MemoryCandidateListResult, MemoryCandidateListQuery>(
    'searcht.memory.candidates.list'
  ),
  submitCandidate: bridge.buildProvider<MemoryCandidate, MemoryCandidateSubmitInput>(
    'searcht.memory.candidates.submit'
  ),
  confirmCandidate: bridge.buildProvider<MemoryItem, MemoryCandidateConfirmInput>('searcht.memory.candidates.confirm'),
  rejectCandidate: bridge.buildProvider<void, { id: string }>('searcht.memory.candidates.reject'),
  listMemories: bridge.buildProvider<MemoryListResult, MemoryListQuery>('searcht.memory.items.list'),
  getMemory: bridge.buildProvider<MemoryItem | null, { id: string }>('searcht.memory.items.get'),
  createMemory: bridge.buildProvider<MemoryItem, MemoryCreateInput>('searcht.memory.items.create'),
  updateMemory: bridge.buildProvider<MemoryItem, MemoryUpdateInput>('searcht.memory.items.update'),
  forgetMemory: bridge.buildProvider<void, { id: string }>('searcht.memory.items.forget'),
  retrieve: bridge.buildProvider<MemoryRetrieveResult, MemoryRetrieveInput>('searcht.memory.retrieve'),
  getStatus: bridge.buildProvider<MemoryStatus, void>('searcht.memory.status'),
  exportMemories: bridge.buildProvider<MemoryExport, void>('searcht.memory.export'),
};

export const skillLifecycle = {
  listCandidates: bridge.buildProvider<SkillCandidateListResult, SkillCandidateListQuery>(
    'searcht.skills.candidates.list'
  ),
  getCandidate: bridge.buildProvider<SkillCandidate | null, { id: string }>('searcht.skills.candidates.get'),
  submitCandidate: bridge.buildProvider<SkillCandidate, SkillCandidateSubmitInput>('searcht.skills.candidates.submit'),
  updateCandidate: bridge.buildProvider<SkillCandidate, SkillCandidateUpdateInput>('searcht.skills.candidates.update'),
  rejectCandidate: bridge.buildProvider<void, { id: string }>('searcht.skills.candidates.reject'),
  listManagedSkills: bridge.buildProvider<ManagedSkillListResult, void>('searcht.skills.managed.list'),
  getManagedSkill: bridge.buildProvider<ManagedSkill | null, { idOrSlug: string }>('searcht.skills.managed.get'),
  listVersions: bridge.buildProvider<SkillVersionListResult, { skillId: string }>('searcht.skills.versions.list'),
  getVersion: bridge.buildProvider<SkillVersion | null, { id: string }>('searcht.skills.versions.get'),
  publishCandidate: bridge.buildProvider<SkillPublishResult, SkillPublishInput>('searcht.skills.candidates.publish'),
  rollback: bridge.buildProvider<SkillPublishResult, SkillRollbackInput>('searcht.skills.versions.rollback'),
  updateState: bridge.buildProvider<ManagedSkill, SkillStateUpdateInput>('searcht.skills.managed.state'),
  getStatus: bridge.buildProvider<SkillLifecycleStatus, void>('searcht.skills.status'),
};

export const workflow = {
  list: bridge.buildProvider<WorkflowListResult, void>('searcht.workflows.list'),
  listDeleted: bridge.buildProvider<WorkflowListResult, void>('searcht.workflows.deleted.list'),
  get: bridge.buildProvider<WorkflowInstance | null, { id: string }>('searcht.workflows.get'),
  install: bridge.buildProvider<{ workflow: WorkflowInstance; version: WorkflowVersion }, WorkflowInstallInput>(
    'searcht.workflows.install'
  ),
  listVersions: bridge.buildProvider<WorkflowVersion[], { workflowId: string }>('searcht.workflows.versions.list'),
  createVersion: bridge.buildProvider<WorkflowVersion, WorkflowVersionCreateInput>('searcht.workflows.versions.create'),
  setState: bridge.buildProvider<WorkflowInstance, { id: string; state: Exclude<WorkflowInstanceState, 'deleted'> }>(
    'searcht.workflows.state'
  ),
  rebindRuntimeJob: bridge.buildProvider<WorkflowInstance, { id: string; runtimeJobId: string }>(
    'searcht.workflows.runtime.rebind'
  ),
  remove: bridge.buildProvider<WorkflowInstance, { id: string }>('searcht.workflows.remove'),
  restore: bridge.buildProvider<WorkflowInstance, { id: string }>('searcht.workflows.restore'),
  startRun: bridge.buildProvider<
    WorkflowRun,
    { workflowId: string; runtimeRunKey: string; input: Record<string, unknown> }
  >('searcht.workflows.runs.start'),
  markRunDispatched: bridge.buildProvider<WorkflowRun, { runId: string; conversationId: string }>(
    'searcht.workflows.runs.dispatched'
  ),
  completeRun: bridge.buildProvider<
    WorkflowRun,
    {
      runId: string;
  ...
  >('searcht.workflows.runs.complete'),
  listRuns: bridge.buildProvider<WorkflowRunListResult, { workflowId?: string }>('searcht.workflows.runs.list'),
  listApprovals: bridge.buildProvider<WorkflowApproval[], { runId: string }>('searcht.workflows.approvals.list'),
  decideApproval: bridge.buildProvider<WorkflowApproval, { id: string; decision: 'approved' | 'rejected' }>(
    'searcht.workflows.approvals.decide'
  ),
  listGrants: bridge.buildProvider<WorkflowGrant[], { workflowId?: string }>('searcht.workflows.grants.list'),
  saveGrant: bridge.buildProvider<WorkflowGrant, WorkflowGrant>('searcht.workflows.grants.save'),
  revokeGrant: bridge.buildProvider<void, { id: string }>('searcht.workflows.grants.revoke'),
};
