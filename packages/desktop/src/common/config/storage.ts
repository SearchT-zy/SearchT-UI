...
export interface IConfigStorageRefer {
  ...
  // Desktop Pet: selected character id (see PET_CHARACTERS in petTypes.ts)
  'pet.character'?: string;
}
...
export interface IEnvStorageRefer {
  /** Legacy pre-fork key; kept so customized system dirs survive the rebrand. */
  'aionui.dir'?: {
    workDir: string;
    cacheDir: string;
    logDir?: string;
