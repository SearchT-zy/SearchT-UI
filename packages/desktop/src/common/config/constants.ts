 ...
 */
export const BROWSER_SESSION_PARTITION = 'persist:searcht-browser';
 ...
 */
export const BUILTIN_BROWSER_MCP_NAME = 'searcht-browser';
export const BUILTIN_MEMORY_MCP_NAME = 'searcht-memory';

// ===== 文件处理相关常量 =====

/** 临时文件时间戳分隔符 */
export const SEARCHT_TIMESTAMP_SEPARATOR = '_searcht_';

/** 用于匹配和清理时间戳后缀的正则表达式 */
export const SEARCHT_TIMESTAMP_REGEX = /_searcht_\d{13}(\.\w+)?$/;
export const SEARCHT_FILES_MARKER = '[[AION_FILES]]';
