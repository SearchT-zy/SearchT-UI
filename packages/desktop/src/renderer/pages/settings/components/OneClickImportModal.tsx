...
import SearchtSteps from '@/renderer/components/base/SearchtSteps';
  ...
  return (
    ...
    >
      <div className='flex min-h-0 flex-col'>
        ...
        <div className='mb-6'>
          <SearchtSteps current={currentStep} size='small'>
            <SearchtSteps.Step
            ...
            />
            <SearchtSteps.Step title={t('settings.mcpStepImportSuccess')} />
          </SearchtSteps>
        </div>
