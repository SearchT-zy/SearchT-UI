...
export const useConversationActions = ({
  ...
  /**
   * Remove project state — rendered via SearchtModal in the GroupedHistory component.
   * Uses project's design system: SearchtModal component with danger-styled action button.
   */
