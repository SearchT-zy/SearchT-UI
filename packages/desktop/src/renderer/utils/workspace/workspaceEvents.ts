export const WORKSPACE_TOGGLE_EVENT = 'searcht-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'searcht-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'searcht-workspace-has-files';
