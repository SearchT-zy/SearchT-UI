  ...
  void import('@sentry/electron/renderer')
    .then((Sentry) => {
      Sentry.withScope((scope) => {
        scope.setTag('searcht.installation_integrity', event.failure_kind ?? 'unknown');
        scope.setTag('searcht.runtime_resource', event.resource);
        scope.setTag('searcht.runtime_resource_id', event.resource_id ?? '');
        scope.setTag('searcht.runtime_scope', event.scope.kind);
