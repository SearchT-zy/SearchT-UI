        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <SearchtSelect value={source} onChange={handleSourceChange}>
                <SearchtSelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</SearchtSelect.Option>
                <SearchtSelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</SearchtSelect.Option>
                <SearchtSelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</SearchtSelect.Option>
              </SearchtSelect>
            </Form.Item>
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <SearchtSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <SearchtSelect.Option key={option.value || 'auto'} value={option.value}>
