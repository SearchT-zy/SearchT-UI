                ...
                {imageGenerationModelList.length > 0 ? (
                  ...
                  >
                    {imageGenerationModelList.map(({ models, ...platform }) => (
                      <SearchtSelect.OptGroup label={platform.name} key={platform.id}>
                        {models.map((modelName) => (
                          <SearchtSelect.Option key={platform.id + modelName} value={platform.id + '|' + modelName}>
                            {modelName}
                    ...
                    <Tooltip
                      content={
                        <div>
                          ...
                          <a
                            href='https://github.com/SearchT-zy/SearchT/wiki/SearchT-Image-Generation-Tool-Model-Configuration-Guide'
                            target='_blank'
