...
const SearchtSearchInput = forwardRef<HTMLInputElement, SearchtSearchInputProps>((props, ref) => {
  const {
    value,
    onChange,
    placeholder,
...
SearchtSearchInput.displayName = 'SearchtSearchInput';

export default SearchtSearchInput;
