...
type SearchtSelectSize = NativeSelectSize | 'middle';

export interface SearchtSelectProps extends NativeSelectProps {
  /** 额外的类名 / Additional class name */
  className?: string;
  /** 统一尺寸，新增 middle（32px）/ Unified size with additional "middle" (32px) */
  size?: SearchtSelectSize;
}

/**
 * 基础样式类名
 * 注意：主题相关样式（背景色、边框色）在 arco-override.css 的 .searcht-select 类中定义
 * Note: Theme-related styles (background, border colors) are defined in .searcht-select class in arco-override.css
 */
 ...
 * ```tsx
 * // 基本用法 / Basic usage
 * <SearchtSelect placeholder="请选择" style={{ width: 200 }}>
 *   <SearchtSelect.Option value="1">选项1</SearchtSelect.Option>
 *   <SearchtSelect.Option value="2">选项2</SearchtSelect.Option>
 * </SearchtSelect>
 *
 * // 多选 / Multiple selection
 * <SearchtSelect mode="multiple" placeholder="请选择多个">
 *   <SearchtSelect.Option value="1">选项1</SearchtSelect.Option>
 *   <SearchtSelect.Option value="2">选项2</SearchtSelect.Option>
 * </SearchtSelect>
 *
 * // 分组 / Grouped options
 * <SearchtSelect placeholder="请选择">
 *   <SearchtSelect.OptGroup label="分组1">
 *     <SearchtSelect.Option value="1">选项1</SearchtSelect.Option>
 *   </SearchtSelect.OptGroup>
 *   <SearchtSelect.OptGroup label="分组2">
 *     <SearchtSelect.Option value="2">选项2</SearchtSelect.Option>
 *   </SearchtSelect.OptGroup>
 * </SearchtSelect>
 * ```
 *
 * @see arco-override.css for theme-related styles (.searcht-select)
 */
const mapSizeToNative = (size?: SearchtSelectSize): NativeSelectSize | undefined => {
  if (!size) return undefined;
  if (size === 'middle') return 'default';
  return size;
};

type SearchtSelectComponent = React.ForwardRefExoticComponent<SearchtSelectProps & React.RefAttributes<SelectHandle>> & {
  Option: typeof Select.Option;
  OptGroup: typeof Select.OptGroup;
};

const InternalSelect = React.forwardRef<SelectHandle, SearchtSelectProps>(
...
const SearchtSelect = InternalSelect as SearchtSelectComponent;

SearchtSelect.displayName = 'SearchtSelect';

// 导出子组件 / Export sub-components
SearchtSelect.Option = Select.Option;
SearchtSelect.OptGroup = Select.OptGroup;

export default SearchtSelect;
