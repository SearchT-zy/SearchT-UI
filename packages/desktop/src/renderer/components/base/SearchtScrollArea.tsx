 ...
 * <SearchtScrollArea className="h-400px">
 *   <div>Content...</div>
 * </SearchtScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <SearchtScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </SearchtScrollArea>
 *
 * // 双向滚动 / Both directions
 * <SearchtScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </SearchtScrollArea>
 * ```
 */
interface SearchtScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const SearchtScrollArea: React.FC<SearchtScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
SearchtScrollArea.displayName = 'SearchtScrollArea';

export default SearchtScrollArea;
