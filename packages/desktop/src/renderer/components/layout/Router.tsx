...
const SkillReviewPage = React.lazy(
  () => import('@renderer/pages/settings/SkillsSettings/consolidation/SkillReviewPage')
);
...
const PersonalWorkspaceSettings = React.lazy(() => import('@renderer/pages/settings/PersonalWorkspaceSettings'));
const ConnectionsSettings = React.lazy(() => import('@renderer/pages/settings/ConnectionsSettings'));
const MemorySettings = React.lazy(() => import('@renderer/pages/settings/memory'));
...
const TodayPage = React.lazy(() => import('@renderer/pages/personal/TodayPage'));
const InboxPage = React.lazy(() => import('@renderer/pages/inbox'));
...
const CalendarPage = React.lazy(() => import('@renderer/pages/calendar'));
const PersonalStartRedirect = React.lazy(() => import('@renderer/pages/personal/PersonalStartRedirect'));
const OnboardingPage = React.lazy(() => import('@renderer/pages/onboarding'));
  ...
  return (
    <HashRouter>
      <Routes>
        <Route
          path='/login'
          element={status === 'authenticated' ? <Navigate to='/' replace /> : withRouteFallback(LoginPage)}
        />
        <Route element={<ProtectedLayout layout={layout} />}>
          <Route index element={withRouteFallback(PersonalStartRedirect)} />
          <Route path='/onboarding' element={withRouteFallback(OnboardingPage)} />
          <Route path='/today' element={withRouteFallback(TodayPage)} />
          <Route path='/inbox' element={withRouteFallback(InboxPage)} />
          ...
          <Route path='/settings/skills/review/:candidateId' element={withRouteFallback(SkillReviewPage)} />
          ...
          <Route path='/settings/personal-workspace' element={withRouteFallback(PersonalWorkspaceSettings)} />
